...
class CocoDataset(Dataset):
    def __init__(self, image_dir, ann_file, transforms):
        ...
        self.img_ids = [img_id for img_id in sorted(list(self.coco.imgs.keys())) if self.has_valid_annotation(img_id)]
    ...
    def __getitem__(self, index):
        ...
        target.add_field("bboxes", BoxList(boxes, image.size, mode="xywh"))
